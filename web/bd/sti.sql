...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-12-2018 a las 07:16:53
...
(0, 'ppp', 'avanzado'),
(15695, 'Programacion basica', 'Principiante'),
(123123, 'kkk', 'avanzado'),
(789985, 'chamoi', 'avanzado');
...
--
-- Volcado de datos para la tabla `preguntas_test_inteligencia`
--

INSERT INTO `preguntas_test_inteligencia` (`id_pregunta_test`, `num_pregunta`, `pregunta`, `id_inteligencias`) VALUES
(893, 99, 'pregunta', 159345),
(159345, 8998, 'asdasd', 159345),
(1111111112, 22222222, 'pregunta2', 88282);
